    ...
    const approachSteps = [
        {
            ...
            description: "We begin with a comprehensive analysis of your current ESG performance and identify key areas for improvement."
        },
        {
            id: 2,
            title: "Strategy Development",
            description: "We co-create a tailored ESG strategy aligned with your business objectives and stakeholder expectations."
        },
        {
            id: 3,
            title: "Implementation Support",
            description: "We provide hands-on support to implement initiatives, ensuring effective execution and change management."
        }
    ];
                        ...
                        <Row className="justify-content-center text-center">
                            <Col lg={8}>
                                ...
                                <p className="lead fw-semibold">
                                    At Ecovibe Kenya, we provide comprehensive ESG (Environmental, Social, and Governance)
                                    consultancy services tailored to help your organization thrive in the evolving sustainability landscape.
                                </p>
                            </Col>
                        </Row>
                    </Container>
                                    ...
                                    <Col key={service.id} lg={4} md={6} className="mb-4">
                                        <Card className="h-100 shadow-sm border-0 service-card">
                                            ...
                                            <Card.Body className="p-4 d-flex flex-column">
                                                <Card.Title className="fw-bold mb-3" style={{ color: '#37b137' }}>
                                                    {service.title}
                                                </Card.Title>
                                ...
                                <Row className="align-items-center">
                                    <Col lg={6} className="mb-4 mb-lg-0">
                                        ...
                                        <p className="text-muted mb-4">
                                            ...
                                            industry, and goals.
                                            We combine global best practices with local insights to develop
                                            practical, implementable strategies that drive meaningful change while delivering
                                            business value. Our team stays at the forefront of the evolving ESG landscape,
                                            ensuring that our clients are always ahead of regulatory changes and market expectations.
                                        </p>
                                        <Button
                                            size="lg"
                                            className="px-4"
