            ...
            <Row className="justify-content-center text-center">
              <Col lg={8}>
                ...
                <p className="lead fw-semibold">
                  At ECK we evaluate the Nationally Determined Contributions and
                  convert them into National Adaptation Plans per sector. This
                  helps to align your business with the country's goals set in
