...
const PostCreationModal = ({ isOpen, onClose }) => {
  ...
  // Static options
  const categories = ['Select category', 'Technology', 'Design', 'Marketing', 'Finance'];
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Post Submitted:', { title, category, excerpt, content, isNewsletter, status });
    onClose();
  };
      ...
      >
        ...
        <div className="modal-content rounded-4 shadow-lg">
          ...
          <div className="modal-header border-bottom-0 p-4">
            <h5 className="modal-title fw-semibold d-flex align-items-center text-dark" id="postModalLabel">
              {/* Plus icon */}
              <svg xmlns="http://www.w3.org/2000/svg" className="text-success me-2" width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-footer d-flex justify-content-between align-items-center p-4 pt-3 border-top-0">
              ...
              <div className="d-flex align-items-center">
                ...
                >
                  {/* Close/Cancel icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" className="me-1" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
