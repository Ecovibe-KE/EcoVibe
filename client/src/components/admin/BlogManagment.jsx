...
const PostBadge = ({ text, colorClass, bgColorClass, hasIcon = false }) => {
  return (
    ...
    <span className={`badge rounded-pill ${bgColorClass} ${colorClass} py-1 px-2 me-1`}>
      {hasIcon && <span className="d-inline-block me-1 rounded-circle" style={{ width: '0.5rem', height: '0.5rem', backgroundColor: colorClass.includes('green') ? 'var(--bs-green)' : 'var(--bs-yellow)' }}></span>}
...
const BlogManagementUi = () => {
  ...
  const categoryOptions = ['All Categories', 'Compliance', 'ESG', 'Regulations', 'Finance'];
  ...
  const mockPost = {
    ...
    description: "Kenya's updated ESG compliance requirements for 2024 and how they affect your sustainability strategy.",
      ...
      <div className="container-fluid">
        ...
        <header className="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-4">
          <div>
            ...
            <p className="text-secondary mt-1">Create and manage blog posts, announcements, and insights</p>
          </div>
          <Button action={"add"} variant='primary' label={"Create Post"} onClick={openModal} />
        </header>

        {/* Stat Cards Section - Uses Bootstrap Grid (Row/Col) */}
        <div className="row g-4 mb-4">
          <div className="col-12 col-md-3">
            <StatCard icon={<LibraryBooksIcon fontSize="large" color='primary'/>} value="5" label="Total Posts" />
          </div>
          <div className="col-12 col-md-3">
            <StatCard icon={<CardMembershipIcon fontSize='large' color='success'/>} value="3" label="Published" />
          </div>
          <div className="col-12 col-md-3">
            <StatCard icon={<EditNoteIcon fontSize='large' color='warning'/>} value="1" label="Drafts" />
          </div>
        </div>
            ...
            <div className="d-flex gap-3">
              ...
              <div className="dropdown" style={{ width: '11rem' }}>
                ...
                >
                  ...
                  <ChevronDown className={`ms-2 small transition-transform ${isCategoriesOpen ? 'rotate-180' : 'rotate-0'}`} />
                </button>
                
                {isCategoriesOpen && (
                  <div className="dropdown-menu show rounded-3 shadow-lg p-0" style={{ minWidth: '100%', border: '1px solid var(--bs-light-border-subtle)' }}>
              ...
              <div className="dropdown" style={{ width: '9rem' }}>
                ...
                >
                  ...
                  <ChevronDown className={`ms-2 small transition-transform ${isStatusOpen ? 'rotate-180' : 'rotate-0'}`} />
                </button>
                
                {isStatusOpen && (
                  <div className="dropdown-menu show rounded-3 shadow-lg p-0 end-0" style={{ minWidth: '100%', border: '1px solid var(--bs-light-border-subtle)' }}>
        ...
        <div className="card shadow-lg border-0 p-4 rounded-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
          <div className="flex-grow-1 min-w-0 me-md-4">
            {/* Tags/Badges */}
            <div className="mb-2">
              <PostBadge text="published" colorClass="text-success" bgColorClass="bg-success-subtle" hasIcon={true} />
              <PostBadge text="Compliance" colorClass="text-primary" bgColorClass="bg-primary-subtle" />
              <PostBadge text="Featured" colorClass="text-warning" bgColorClass="bg-warning-subtle" hasIcon={true} />
            </div>
            ...
            <div className="d-flex flex-wrap align-items-center small text-secondary">
              <div className="d-flex align-items-center me-3">
                ...
                {mockPost.categories.map(tag => (
                  <span key={tag} className="badge bg-secondary-subtle text-dark-emphasis rounded-pill me-1">
                    {tag}
                  </span>
                ))}
              ...
              <div className="d-flex align-items-center me-3 mt-2 mt-sm-0">
                <User className="text-secondary me-1" style={{ width: '1rem', height: '1rem' }} />
                <span className="fw-medium">{mockPost.author}</span>
              </div>
              <div className="d-flex align-items-center mt-2 mt-sm-0">
                <Calendar className="text-secondary me-1" style={{ width: '1rem', height: '1rem' }} />
          ...
          <div className="d-flex gap-2 mt-3 mt-md-0 flex-shrink-0">
            <Button action="update" label="Edit Post" outline hoverColor={"#FFF"} hoverTextColor={"#000"} />
