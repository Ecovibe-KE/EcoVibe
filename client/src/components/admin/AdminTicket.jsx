...
const fetchStats = useCallback(async () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return <Badge bg={info.bg} className="me-1">{info.icon}</Badge>;
  };
                  ...
                  {tickets.map(ticket => (
                    <tr key={ticket.id}>
                      ...
                      <td>
                        ...
                        <span className="text-capitalize">{ticket.status?.replace('_', ' ')}</span>
                      </td>
                      <td>
        ...
        <Row className="mb-3">
          <Col md={6}>
            ...
            <div className="mb-2">
              ...
              <div className="mt-1 text-capitalize">{ticket.category || 'General'}</div>
            </div>
          </Col>
          <Col md={6}>
            <div className="mb-2">
            ...
            <div className="mb-2">
              ...
              <div className="mt-1"><small>{new Date(ticket.created_at).toLocaleString()}</small></div>
            </div>
          </Col>
        </Row>
        ...
        <div className="mb-3 d-flex gap-2">
          {editMode ? (
            ...
            <>
              ...
              <Button variant="danger" size="sm" onClick={() => onDelete(ticket.id)}>
                Delete Ticket
              </Button>
            </>
          )}
            ...
            >
              <Card.Body className="py-2 px-3">
                <div className="d-flex justify-content-between mb-1">
                  ...
                  <small className={message.sender_role !== 'client' ? 'text-white-50' : 'text-muted'}>
