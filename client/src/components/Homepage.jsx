  ...
  return (
    <>
      <section className="bg-secondary">
        <Card className="bg-dark text-white border-0 rounded-0 vh-100">
          ...
          <Card.ImgOverlay className="d-flex flex-column justify-content-center align-items-center text-center">
            <h1 className="display-4 display-md-3 display-lg-2 fw-bold mb-3">
              ECOVIBE KENYA
            </h1>
            <p className="lh-1 fw-bold fst-italic myhero-p">
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="lead mx-auto col-lg-8">
              Our programs empower leaders, innovators, and community members
              with the tools to accelerate local and national transitions to
      ...
      <section className="p-3 p-md-5 bg-light">
        ...
        <p
          className="mx-auto lead fs-4 mb-3 text-center"
          ...
          <div className="row align-items-center g-5">
            <div className="col-12 col-lg-6">
              ...
              <p className="mt-4 text-muted">
                ...
                sustainable development goals such as responsible consumption
                and production, decent work, and climate action.
              </p>
            </div>
            <div className="col-12 col-lg-6">
