...
const InvoiceDashboard = () => {
  ...
  // Define mock data for services and transactions
  const [servicesData] = useState({
    1: ["Regulatory Review", "Documentation", "Gap Analysis"],
    2: ["Compliance Audit", "Reporting"],
    3: ["Consultation", "Implementation Support"],
  });

  const [transactionData] = useState({
    1: { transactionId: "TRX001", status: "completed" },
    2: { transactionId: "TRX002", status: "pending" },
    3: { transactionId: "TRX003", status: "failed" },
  });
  ...
  }, [currentUserRole]); // depends on role
