...
function ServiceAdminTop({ imageSource, number, text, imageSetting, colSetting }) {
    return (
        <Col className={`p-0 ${colSetting}`}>
            <aside className="shadow p-3 rounded-2 bg-white d-flex align-items-center">
                <img src={imageSource} className={`bg-${imageSetting}-subtle rounded-2 me-3 object-fit-contain`} />
                <section>
