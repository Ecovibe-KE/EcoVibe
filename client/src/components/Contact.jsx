                    ...
                    <div className="mb-4">
                      {siteKey ? (
                        ...
                        <div className="alert alert-warning">
                          reCAPTCHA is not configured. Please contact Site
                          Owner.
                        </div>
                      )}
                    </div>
            ...
            >
              ...
              <div className="d-flex flex-column gap-4">
                <div className="d-flex align-items-start">
                  <i
                    className="bi bi-envelope-fill me-3 mt-1"
                    style={{ color: "#37B137", fontSize: "1.2rem" }}
                  ></i>
                  <div>
                    <p className="mb-0">
                      <a
                        href="mailto:info@ecovibe.co.ke"
                ...
                {/* <div className="d-flex align-items-start">
                  ...
                  <div>
                    <p className="mb-0 text-muted">
                      The Mint Hub Offices Western Heights, <br></br>
                      10th Floor<br></br>
                      P.O Box 216-00606
                      <br></br>
                      Nairobi, Kenya{" "}
                ...
                <div className="d-flex align-items-start">
                  <i
                    className="bi bi-clock-fill me-3 mt-1"
                    style={{ color: "#37B137", fontSize: "1.2rem" }}
                  ></i>
                  <div>
                    <p className="mb-0 text-muted">
