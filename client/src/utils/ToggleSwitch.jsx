export const ToggleSwitch = ({ label, checked, onChange }) => (
  <div className="d-flex align-items-center">
    <label htmlFor="newsletter-toggle" className="form-check-label text-secondary fw-medium me-3" style={{ fontSize: '0.875rem' }}>
      {label}
    </label>
    <div className="form-check form-switch p-0" style={{ position: 'relative', width: '2.75rem', height: '1.5rem' }}>
      <input
        type="checkbox"
        name="toggle"
