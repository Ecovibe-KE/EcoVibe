...
def test_create_booking_as_admin_for_client(client, admin_user, test_user, sample_service):
...
def test_create_booking_past_date(client, test_user, sample_service):
    ...
    booking_data = create_booking_data(sample_service.id, days_from_today=-1)  # Past date
