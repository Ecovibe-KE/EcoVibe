...
def upgrade():
    ...
    op.add_column(
        "documents", sa.Column("title", sa.String(length=255), nullable=False)
    )
    op.add_column("documents", sa.Column("file_data", sa.LargeBinary(), nullable=False))
    op.add_column(
        "documents", sa.Column("filename", sa.String(length=255), nullable=False)
    )
    op.add_column(
        "documents", sa.Column("mimetype", sa.String(length=100), nullable=False)
    )
...
def downgrade():
    ...
    op.add_column(
        "documents",
        sa.Column(
            "file_path", sa.VARCHAR(length=200), autoincrement=False, nullable=False
        ),
    )
