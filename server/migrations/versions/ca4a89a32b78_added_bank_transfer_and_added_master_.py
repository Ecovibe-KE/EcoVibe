...
def upgrade():
    ...
    op.add_column('payments', sa.Column('bank_transfer_transaction_id', sa.Integer(), nullable=True))
    op.add_column('payments', sa.Column('paybill_transaction_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'payments', 'paybill_transactions', ['paybill_transaction_id'], ['id'])
    op.create_foreign_key(None, 'payments', 'bank_transfer_transactions', ['bank_transfer_transaction_id'], ['id'])
