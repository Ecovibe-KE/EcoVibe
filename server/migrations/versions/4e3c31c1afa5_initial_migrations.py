...
def upgrade():
    ...
    op.create_table('bank_transfer_transactions',
    ...
    op.create_table('paybill_configs',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('paybill_transactions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('amount', sa.Numeric(precision=12, scale=2), nullable=False),
    sa.Column('paybill_number', sa.String(length=20), nullable=False),
    ...
    sa.Column('account_status', sa.Enum('ACTIVE', 'SUSPENDED', 'INACTIVE', 'DELETED', name='accountstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('image', sa.LargeBinary(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'DELETED', name='servicestatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('OPEN', 'CLOSED', 'IN_PROGRESS', 'DELETED', name='ticketstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['admin_id'], ['users.id'], ),
    ...
    sa.Column('status', sa.Enum('pending', 'paid', 'overdue', 'cancelled', 'deleted', name='invoicestatus'), nullable=False),
    sa.Column('is_deleted', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['client_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('payment_method', sa.Enum('MPESA', 'CASH', 'CARD', 'BANK_TRANSFER', 'PAYBILL', name='paymentmethod'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['bank_transfer_transaction_id'], ['bank_transfer_transactions.id'], ),
    sa.ForeignKeyConstraint(['card_transaction_id'], ['card_transactions.id'], ),
    ...
    sa.ForeignKeyConstraint(['paybill_transaction_id'], ['paybill_transactions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
