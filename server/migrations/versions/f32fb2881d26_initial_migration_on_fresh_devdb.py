"""Initial migration on fresh devdb

Revision ID: f32fb2881d26
Revises: 
Create Date: 2025-10-07 14:41:47.184524
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('pending', 'confirmed', 'completed', 'cancelled', 'deleted', name='bookingstatus'), nullable=False),
    sa.Column('client_id', sa.Integer(), nullable=False),
