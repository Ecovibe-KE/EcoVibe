...
class Ticket(db.Model):
    ...
    client = db.relationship("User", foreign_keys=[client_id], back_populates="client_tickets")
    admin = db.relationship("User", foreign_keys=[assigned_admin_id], back_populates="admin_tickets")
